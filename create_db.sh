#!/bin/bash
ldbname=$( echo $1 |tr 'A-Z' 'a-z' )
udbname=$( echo $1 |tr 'a-z' 'A-Z' )
linst=$( echo $USER |tr 'A-Z' 'a-z' )
uinst=$( echo $USER |tr 'a-z' 'A-Z' )
lappl=$( echo $ldbname |cut -c1-4 | tr 'A-Z' 'a-z' )
uappl=$( echo $lappl | tr 'a-z' 'A-Z' )
env=$( echo $udbname |cut -c5-5 | tr 'a-z' 'A-Z' )
envno=$( echo $udbname |cut -c6-6 | tr 'a-z' 'A-Z' )
...
##Create Schemas
 ##db2 -v "CREATE SCHEMA ABCD  AUTHORIZATION ${uappl}${env}DS${envno}"
 db2 -v "CREATE SCHEMA ABCD  AUTHORIZATION ABCD"
 db2 -v "CREATE SCHEMA TEST AUTHORIZATION ${uappl}${env}DS${envno}"

##Create Authorisations
 db2 -v "GRANT CREATETAB,BINDADD,CONNECT,CREATE_NOT_FENCED,IMPLICIT_SCHEMA, LOAD ON DATABASE TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT CONNECT ON DATABASE TO GROUP ${uappl}${env}${envno}RO"

 db2 -v "GRANT USE OF TABLESPACE USERS TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE INDX TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE BLOB_TBL_DATA TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE TEMP_USER TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE XML_DATA TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE XML_LARGE_DATA TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE XML_INDEX TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE ICM_DATA TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE ICM_IX TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE ITM_DATA TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE ITM_IX TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE ITD_DATA TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE ITD_IX TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE ITA_DATA TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE ITA_IX TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE LCK_DATA TO GROUP ${uappl}${env}${envno}RW"
 db2 -v "GRANT USE OF TABLESPACE LCK_IX TO GROUP ${uappl}${env}${envno}RW"
